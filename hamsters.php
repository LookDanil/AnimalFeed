...
<head>
    ...
    <style>
        .produsction{
            ...
            min-height: 100vh;
            padding-top: 10vh;
            background: url(img/back_ham.jpg) no-repeat center top / cover;
                ...
                <center><p class="hello_admin">Добро пожаловать на интернет портал,<?= $_SESSION['admin']['full_name']?>!</p></center>
                    <div class="cat_title">
                        <div class="cat_title-text">
                            <h3>Милый грызунчик будет заполнит свои щеки нашим кормом</h3>
                            <p class="cat_feed">Ему даже не придется делать запасы!</p>
                        </div>
                            ...
                            <div class="modal" data-modal="1">
                                ...
                                <div class="modal_disp">
                                    <form action="vendor/addProduct.php" method="post" enctype="multipart/form-data">
                                        <input   type="text" name="state_category"  value="hamsters.php" style="display:none;"> 
                    ...
                    <div class="product_box">
                        ...
                        <?php
                            $con=mysqli_connect('localhost', 'root', 'root', 'animalfeed');
                            $query1 = mysqli_query($con, "SELECT * FROM `feeds` WHERE `category` = 'Корм для грызунов'");
                            while($row=mysqli_fetch_array($query1)){
                                echo('
                                <div class="product" onClick="OnOff('.$row['id_product'].')">
                                    ...
                                    <input  class = "name_product input_type" type="text" name="state_category" id="#" value="hamsters.php" style="display:none;"> 
