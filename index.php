                ...
                <center><p class="hello_admin">Добро пожаловать на интернет портал,&nbsp;&nbsp;<?= $_SESSION['admin']['full_name']?>!</p></center>
                    <div class="cat_title">
                        <div class="cat_title-text">
                            <h3>Мы производим лучшие корма для кошек!</h3>
                            <p class="cat_feed">Можете убедиться в этом сами!</p>
                        </div>
                            ...
                            <div class="modal" data-modal="1">
                                ...
                                <div class="modal_disp">
                                    <form action="vendor/addProduct.php" method="post" enctype="multipart/form-data">
                                        <input   type="text" name="state_category"  value="index.php" style="display:none;"> 
                    ...
                    <div class="product_box">
                        ...
                        <?php
                            $con=mysqli_connect('localhost', 'root', 'root', 'animalfeed');
                            $query1 = mysqli_query($con, "SELECT * FROM `feeds` WHERE `category` = 'Кошачий корм'");
                            while($row=mysqli_fetch_array($query1)){
                                echo('
                                <div class="product" onClick="OnOff('.$row['id_product'].')">
                                    ...
                                    <input  class = "name_product input_type" type="text" name="state_category" id="#" value="index.php" style="display:none;"> 
